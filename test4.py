...
def ask_about_missing_symptoms(missing_symptoms, confirmed_symptoms):
...
def interact_with_user():
    ...
    while True:
        ...
        # Vérifier les symptômes manquants
        ...
        if missing_symptoms:
            confirmed_symptoms = ask_about_missing_symptoms(missing_symptoms, confirmed_symptoms)
